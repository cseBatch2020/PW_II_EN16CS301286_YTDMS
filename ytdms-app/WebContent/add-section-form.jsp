...
<body>
	...
	<span style="color:red;">${param.msg}</span>
		<form action="AddSectionController" method="post">
			<h2 class="form-group text-center mb-5 display-5">Add Section</h2>

			<!-- CATEGORY CONTAINER -->
			<div>
				<select class="custom-select mb-3" id="category-options"
					name="categoryName" required>
					<option selected name="categoryName" value="">---select
						category---</option>
			...
			<div class="form-group">
				<input type="text" class="form-control p-2" id="name"
					placeholder="enter the section name" name="name" required></input>
			...
			<div class="form-group">
				<textarea type="text" class="form-control p-3" id="description"
					placeholder="add description" name="description" required></textarea>
				<span id="descriptionError"></span>

			</div>

			<button type="cancel" class="btn btn-primary" id="cancel-btn">Cancel</button>
