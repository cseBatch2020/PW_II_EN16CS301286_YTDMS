...
/**
 * Servlet implementation class FilterByCategoryController
 */
@WebServlet("/FilterByCategoryController")
public class FilterByCategoryController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Map<Section,String>sections=sectionService.filterbyCategortyName(request.getParameter("categoryName"));
